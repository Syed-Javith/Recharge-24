        ...
        <div id='about-recharge' className={`h-screen-full ${Style.aboutpic}`}>
            <div className='text-center container md:w-[80vw] w-auto pt-20'>
                <div className={Style.glass}>
                    <h1 className={`md:text-[3.5rem] text-[1.5rem] font-bold mb-4 ${SketchFont.className} ${Style.neon}`}>

                        About REC

                    </h1>
                    <div className={`md:text-[1.25rem] flex flex-col gap-4 md:p-12 p-4 text-justify ${paraFont.className}`}>
