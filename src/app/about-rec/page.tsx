...
import "../about-recharge/aboutrec.modules.css"
const page = () => {
    return (
        <div id='about-recharge'>
            <div className='text-center container md:w-[80vw] w-auto mt-20'>
                <h1 className='md:text-[3.5rem] text-[2.5rem] font-bold mb-4'>About REC</h1>
                <div className='md:text-[1.25rem] flex flex-col gap-4 text-justify'>
