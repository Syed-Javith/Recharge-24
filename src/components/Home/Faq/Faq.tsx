  ...
  return (
    <div className="container mx-auto md:px-35 md:py-20">
      ...
      <FaqSection
        ...
        answer={(
          <span>
            Yes, absolutely! Buses will ply from all main routes to and from the college after the proshows. If you want to know bus route details and get other transport-related information, please visit <a href="https://www.rectransport.com/" className="underline">rectransport.com</a>
          </span>
        )}
      />
      ...
      <FaqSection
        ...
        answer={(
          <span>
            REC and RSA alumni can get their proshow passes from the head office at Kilpauk.
          </span>
        )}
      />
      ...
      <FaqSection
        ...
        answer={(
        <span>
          Oh yes! Recharge proshows are open to all! Keep an eye on our instagram handle <a className="underline" href='https://www.instagram.com/recharge_fest/'>@recharge_fest</a> where we will update you
        </span>
        )}
      />
      ...
      <FaqSection
        ...
        answer={(
        <span>
          No. You must either be an event participant or must have purchased proshow tickets to enter the campus.
        </span>
        )}
      />
      ...
      <FaqSection
        ...
        answer={(
        <span>
          No. Once you leave college premises, you will not be allowed to re-enter on the same day.
        </span>
        )}
      />
      ...
      <FaqSection
        ...
        answer={(
          <span>
            No, you will not be given a new wristband even if you damage yours. Our wristbands are of high-quality and it is advised that you wear yours without damaging it in any way.
          </span>
        )}
      />
      ...
      <FaqSection
        ...
        answer={(
          <span>
            School students can only attend the proshows. They cannot register nor participate in events.
          </span>
        )}
      />
      ...
      <FaqSection
        ...
        answer={(
          <span>
            For any queries related to proshow or event registration mail to <a className="underline" href="mailto:tickets.recharge@rajalakshmi.edu.in">tickets.recharge@rajalakshmi.edu.in </a>
          </span>
        )}
      />
