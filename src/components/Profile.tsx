...
const Profile: FC<ProfileProps> = ({}) => {
  ...
  return (
    ...
    :
      <Card className="max-w-xl mx-auto my-10 rounded-3xl p-5" key={profile.email} style={{
        boxShadow: "0 0 0.4rem #fff, 0 0 0.4rem #fff, 0 0 4rem rgb(0, 191, 255), 0 0 1rem rgb(0, 191, 255), 0 0 1.6rem rgb(0, 191, 255)"
      }}>
        ...
        <div className="flex items-center">
          ...
          <div className="mx-3">
            <div className="flex justify-center items-center">
              <CardTitle className="mr-6">{profile.first_name + " " + profile.last_name}</CardTitle>
        ...
        <CardDescription className="max-w-[150px] mx-auto my-3">
          <img src={profile.qr_code && profile.qr_code} alt="Unique user id" className="rounded-xl"/>
        </CardDescription>
